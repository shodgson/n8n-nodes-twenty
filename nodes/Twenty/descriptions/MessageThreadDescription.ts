...
export const messageThreadFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['messageThread'],
				operation: ['createManyMessageThreads'],
			},
		},
	},
	{
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['messageThread'],
				operation: ['createOneMessageThread'],
			},
		},
	},
	{
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['messageThread'],
				operation: ['deleteOneMessageThread'],
			},
		},
	},
	{
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['messageThread'],
				operation: ['findManyMessageThreads'],
			},
		},
	},
	{
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['messageThread'],
				operation: ['findMessageThreadDuplicates'],
			},
		},
	},
	{
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['messageThread'],
				operation: ['findOneMessageThread'],
			},
		},
	},
	{
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['messageThread'],
				operation: ['updateOneMessageThread'],
			},
		},
	},
	{
