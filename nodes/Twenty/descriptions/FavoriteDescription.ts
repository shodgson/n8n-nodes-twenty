...
export const favoriteFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['favorite'],
				operation: ['findFavoriteDuplicates'],
			},
		},
	},
	{
