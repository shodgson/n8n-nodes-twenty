...
export const personFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['person'],
				operation: ['findPersonDuplicates'],
			},
		},
	},
	{
