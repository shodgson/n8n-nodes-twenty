...
export const messageFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['message'],
				operation: ['findMessageDuplicates'],
			},
		},
	},
	{
