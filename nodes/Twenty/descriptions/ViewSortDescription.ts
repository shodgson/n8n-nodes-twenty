...
export const viewSortFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['viewSort'],
				operation: ['findViewSortDuplicates'],
			},
		},
	},
	{
