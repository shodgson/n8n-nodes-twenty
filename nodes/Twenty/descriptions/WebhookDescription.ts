...
export const webhookFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		displayOptions: {
			show: {
				resource: ['webhook'],
				operation: ['findWebhookDuplicates'],
			},
		},
	},
	{
